                ...
                case 10:
                    if (checkStep(QuestVarp, 0, 0, 0, 0, 0, 0, 0, 0)) {
                        if (currentStepQuestVarp10 == "") {
                            ...
                            var entrancePortal = SceneObjectQuery.newQuery().name("Portal").results().nearest();
                            if (entrancePortal != null) {
                                var portalCoordinate = entrancePortal.getCoordinate();
                                if (portalCoordinate != null) {
                                    ScriptConsole.println(portalCoordinate);
                                    Execution.delay(15000);
                                    Traverse.walkTo(new Coordinate(portalCoordinate.getX() - 1, portalCoordinate.getY() - 20, portalCoordinate.getZ()), false);
                                    Execution.delay(10000);
                                    Traverse.walkTo(new Coordinate(portalCoordinate.getX() - 1 + 14, portalCoordinate.getY() - 20, portalCoordinate.getZ()), false);
                                    Execution.delay(10000);

                                    Traverse.walkTo(new Coordinate(portalCoordinate.getX() - 1 + 14, portalCoordinate.getY() - 20 + 12, portalCoordinate.getZ()), false);
                                    Execution.delay(10000);

                                    Traverse.walkTo(new Coordinate(portalCoordinate.getX() - 1 + 14+ 4, portalCoordinate.getY() - 20 + 12, portalCoordinate.getZ()), false);
                                    Execution.delay(10000);
                    ...
                    if (checkStep(QuestVarp, 1, 0, 0, 0, 0, 0, 0, 0)) {
                        var entrancePortal = SceneObjectQuery.newQuery().name("Archway").results().nearest();
                        if (entrancePortal != null) {
                            var portalCoordinate = entrancePortal.getCoordinate();
                            if (portalCoordinate != null) {
                                Execution.delay(15000);

                                Traverse.walkTo(new Coordinate(portalCoordinate.getX() + 4, portalCoordinate.getY() + 3, player.getZ()), false);
                                Execution.delay(5000);

                                Traverse.walkTo(new Coordinate(portalCoordinate.getX() + 4 + 4, portalCoordinate.getY() + 3, player.getZ()), false);
                                Execution.delay(5000);

                                Traverse.walkTo(new Coordinate(portalCoordinate.getX() + 4 + 4, portalCoordinate.getY() + 3 + 4, player.getZ()), false);
                                Execution.delay(5000);

                                Traverse.walkTo(new Coordinate(portalCoordinate.getX() + 4 + 4 + 1, portalCoordinate.getY() + 3 + 4 - 1, player.getZ()), false);
                                Execution.delay(5000);
                            }
                        }
                        //New Values
