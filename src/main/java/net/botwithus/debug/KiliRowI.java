...
public class KiliRowI {
        ...
        static Coordinate cavetroll = new Coordinate(8610, 3940, 0);
        static Area.Circular trollarea = new Area.Circular(cavetroll, 10);

    public static void quest() {
        int QuestVarp = VarManager.getVarbitValue(53743);
        ...
        if (QuestVarp == 0) {
            ScriptConsole.println("Starting quest... Kili's Row I");
                ...
                if (ritualarea.contains(player) && progress < needed) {
                    ...
                    if(pedestal != null)
                    {
                        ...
                        if (elementglyph.size() < 1)
                            ...
                            ScriptConsole.println("P1Progress: " + progress + " Needed: " + needed);
                            doRitual();
                        }
                    }
                } else {
