...
import net.botwithus.api.game.hud.magic.MagicAbility;
...
public class InAidoftheMyreque {
    ...
    static Coordinate Florincord = new Coordinate(3485, 3245, 0);
    ...
    static Coordinate hideout = new Coordinate(3508, 9837, 0);
    static Area.Circular hideoutarea = new Area.Circular(hideout, 10);
    public static boolean cornelioustalked = false;
    public static boolean talkedtovelia = false; // varbit 290 nned to talk to him then soemone else
    public static boolean option2derzel = false;
    public static void quest() {
        ...
        if (QuestVarp == 0) {
            ...
            } else if (hideoutarea.contains(player)) {
                talktoVeliafHurtz();
            } else {
            ...
            switch (QuestVarp) {
                ...
                case 30:
                    ...
                    delay(RandomGenerator.nextInt(600, 800));*/
                        ...
                        if (fooduse) {
                            delay(RandomGenerator.nextInt(600, 800));
                            openchest.interact(SELECT_OBJECT.getType());
                            delay(RandomGenerator.nextInt(600, 800));
                        }
                    }
                    break;
                ...
                case 140:
                    ...
                    if (Backpack.getCount("Plank") < 10) {
                        ...
                        Item plank = Backpack.getItem("Plank");
                        if (!bankfixarea.contains(player) && brokenroof == null) {
                            ...
                            // }
                                ...
                                boolean plankuseroof = MiniMenu.interact(SELECTABLE_COMPONENT.getType(), 0, plank.getSlot(), 96534533);
                                if (plankuseroof) {
                                    delay(RandomGenerator.nextInt(600, 800));
                                    brokenroof.interact(SELECT_OBJECT.getType());
                                    delay(RandomGenerator.nextInt(600, 800));
                                }
                ...
                case 150:
                    ...
                    if (ladderdownbank != null && player.getZ() == 2) {
                        ...
                        if (damagewall != null && plank != null) {
                            ...
                            if (plankusewall) {
                                delay(RandomGenerator.nextInt(600, 800));
                                damagewall.interact(SELECT_OBJECT.getType());
                                delay(RandomGenerator.nextInt(600, 800));
                            }
                ...
                case 290:
                    ...
                    break;
                case 300:
                    if (Interfaces.isOpen(51)) {
                        delay(RandomGenerator.nextInt(600, 800));
                        MiniMenu.interact(ComponentAction.COMPONENT.getType(), 1, -1, 3342355);
                        delay(RandomGenerator.nextInt(600, 800));
                    } else {
                        talktoIvanStrom();
                    }
                    break;
                case 310:
                    Npc vampire = NpcQuery.newQuery().name("Vampyre Juvinate").health(1,100000).results().nearest();
                    Npc pol = NpcQuery.newQuery().name("Polmafi Ferdygris").results().first();

                if(vampire != null && !Client.getLocalPlayer().hasTarget()){
                    vampire.interact("Attack");
                    delay(RandomGenerator.nextInt(600, 800));
                }else if(pol != null) {
                    if (Interfaces.isOpen(51)) {
                        delay(RandomGenerator.nextInt(600, 800));
                ...
                case 375:
                    if (!canffisbankarea.contains(player) && !Backpack.contains("Rope") && !Backpack.contains("Water rune") && !Backpack.contains("Cosmic rune") && !Backpack.contains("Soft clay") && !Backpack.contains("Sapphire") && !Backpack.contains("Silver bar") && !Backpack.contains("Mithril bar")) {
                        ...
                        if (!woodenboardarea.contains(player)) {
                            ...
                            SceneObject woodenboard = SceneObjectQuery.newQuery().name("Wooden boards").option("Smash-boards").results().first();
                            if (woodenboard != null) {
                                woodenboard.interact("Smash-boards");
                                delay(RandomGenerator.nextInt(600, 800));
                ...
                case 390:
                    ...
                    if (!alkharidfurancearea.contains(player)) {
                        ...
                        if (furnacesmelt != null && !Interfaces.isOpen(37)) {
                            ...
                            if(VarManager.getVarpValue(8332) != 1485){
                               MiniMenu.interact(ComponentAction.COMPONENT.getType(),  1, 1, 2424894);
                                delay(RandomGenerator.nextInt(600, 800));
                            }else if(VarManager.getVarpValue(8333) != 7637){
                                ...
                                delay(RandomGenerator.nextInt(4000, 5000));
                            }
                        }
                ...
                case 420:
                    ...
                    if (!pubcoordbagarea.contains(player) && VeliafHurtz == null) {
                        ...
                        if (brokendownwall1 != null && VeliafHurtz == null) {
                            if (trapdoorpub.distanceTo(player) <= 2) {
    ...
    public static void talktoPolmafia() {
        Npc pol = NpcQuery.newQuery().name("Polmafi Ferdygris").results().first();
        if (pol != null) {
            pol.interact("Talk to");
            delay(RandomGenerator.nextInt(600, 800));
        }
    }
